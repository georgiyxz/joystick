...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IPressKeyActions> m_PressKeyActionsCallbackInterfaces = new List<IPressKeyActions>();
    ...
    public struct PressKeyActions
    {
        ...
        public void AddCallbacks(IPressKeyActions instance)
        {
            if (instance == null || m_Wrapper.m_PressKeyActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PressKeyActionsCallbackInterfaces.Add(instance);
            @Space.started += instance.OnSpace;
            @Space.performed += instance.OnSpace;
            @Space.canceled += instance.OnSpace;
        }

        private void UnregisterCallbacks(IPressKeyActions instance)
        {
            @Space.started -= instance.OnSpace;
            @Space.performed -= instance.OnSpace;
            @Space.canceled -= instance.OnSpace;
        ...
        public void RemoveCallbacks(IPressKeyActions instance)
        {
            if (m_Wrapper.m_PressKeyActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPressKeyActions instance)
        {
            foreach (var item in m_Wrapper.m_PressKeyActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PressKeyActionsCallbackInterfaces.Clear();
